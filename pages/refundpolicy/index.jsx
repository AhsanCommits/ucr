      ...
      <div className="container-style flex-col md:px-12 md:py-20 space-y-8">
        ...
        <ul className="space-y-4 p-2 text-left text-neutral-600 text-base font-light">
          ...
          <li>
            ...
            <ul>
              <li>
                a. Refund requests will be reviewed within [Number] business
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                due to unforeseen circumstances or technical issues on our end,
                we will either provide an alternative solution or issue a full
                refund.
              </li>
            </ul>
          </li>
          <li>
            <strong>7. Chargebacks:</strong>
            <ul>
              <li>
                Customer agrees that no chargebacks will be issued prior to
                making contact with us to settle any disputes. We require
                written agreement to perform a chargeback. If a chargeback is
                issued without prior written agreement, the customer will be
                subject to reimburse us for all fees incurred during the dispute
                process. We reserve the right to pursue legal action if
                necessary to recover any fees owed. If a chargeback is approved,
                the amount will be credited back to the original payment method
                used for the purchase. Please allow up to 10 business days for
                the chargeback to be processed and for the funds to appear in
                your account. If you have any disputes or concerns about your
                purchase, please contact us before issuing a chargeback. We are
                committed to resolving any issues and ensuring that you are
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                need assistance with a refund request, please contact us using
                our contact form.
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li>
                ...
                Policy at any time. We will notify you of any significant
                changes via the Website or other appropriate means.
              </li>
            </ul>
          </li>
          <li>
